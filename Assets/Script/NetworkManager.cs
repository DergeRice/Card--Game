...
public class NetworkManager : MonoBehaviourPunCallbacks , IPunObservable
{
    ...
    public void AlertSomething(string msg)
    {      
        GameObject AlertText = Instantiate(AlertCanvas).transform.GetChild(0).gameObject;
        AlertText.GetComponent<Text>().text = msg;
    }
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        ShowMeRoomList();
        Debug.Log(roomList.Count+"Room Count update");
    }
    ...
    public void ReadBtnEntered()
    {
        ...
        {
            AlertSomething ("혼자서는 게임을 할 수 없어요 ㅠ");
            return;
        }  
        ReadyBtn =! ReadyBtn;
